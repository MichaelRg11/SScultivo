...
<div class="container">
    <center>
        ...
        <div class="mb-2">
            ...
            <?= $this->Html->link(__('Editar monitoreo Ac'), ['action' => 'edit', $monitoreoAc->idmonitoreo_AC], ['class' => 'btn btn-success']) ?>
            <?= $this->Form->postLink(__('Eliminar monitoreo Ac'), ['action' => 'delete', $monitoreoAc->idmonitoreo_AC], ['confirm' => __('Are you sure you want to delete # {0}?', $monitoreoAc->idmonitoreo_AC), 'class' => 'btn btn-success']) ?>
            <?= $this->Html->link(__('Lista de monitoreo Ac'), ['action' => 'index'], ['class' => 'btn btn-success']) ?>
            <?= $this->Html->link(__('Nuevo monitoreo AC'), ['action' => 'add'], ['class' => 'btn btn-success']) ?>
        </div>
    </center>
</div>
<br>
