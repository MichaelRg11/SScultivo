...
<div class="container">
    ...
    <center>
        ...
        <?= $this->Html->link(__('<i class="fas fa-plus" style="font-size:15px"> Agregar nuevo monitoreo terrestre</i>'), ['action' => 'add'], ['escape' => false, 'class' => 'btn btn-primary offset-md-8 h1 mb-2']) ?>
